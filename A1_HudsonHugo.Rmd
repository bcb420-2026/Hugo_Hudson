...
p_value <- Heatmap(z_score_cpm_matrix, show_row_names = FALSE, name="Z-Score Expression")
draw(p_value)
grid.text(str_wrap("Figure 3: Heatmap of the top 100 differentially expressed genes based on p-value. Expression is z-scored counts per million.",width=100), x= 0.32,y=0.0, gp = gpar(fontsize = 8))
...
logfc <- Heatmap(z_score_cpm_matrix_FC, show_row_names = FALSE, name="Z-Score Expression")
logfc
